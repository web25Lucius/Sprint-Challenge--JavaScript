...
// console.log(consume('Ramona', 'Lucius', greeting)); 
...
// Explanation:  You can pull information from the country to the city, but not the other way around.  
//Sort of like a crochet loop, you pull down- not up.   
